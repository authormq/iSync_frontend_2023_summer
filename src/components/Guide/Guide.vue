<template>
  ...
  <div class="guide-cover-container" v-if="cnt === 10" >
  ...
  <div class="guide-cover-container" v-if="cnt === 13" >
  ...
  <div class="guide-cover-container" v-if="cnt === 16" >
    <div class="large-img large-img-10"></div>
    <h3 class="large-text"><em>新建</em>原型设计，用<em>模板</em>快速搓个好看的网页</h3>
  </div>
  <div class="guide-cover-container" v-if="cnt === 17" :class="{'gradually-hide': shouldHide}">
