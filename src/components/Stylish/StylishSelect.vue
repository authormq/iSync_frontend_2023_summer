  ...
  <div class="stylish-select-container" :value="value">
    <div class="stylish-select-content">
      <div class="stylish-select-content-wrapper">
        <div class="stylish-select-content-single" v-if="!multiple">{{ selectedData.length > 0 ? selectedData[0].label :
          '未选中团队' }}</div>
        <div class="stylish-select-content-multiple" v-else v-for="(select, index) in selectedData" :key="index">
          ...
          <svg class="stylish-select-content-multiple-icon" @click="handleDelete(select.value, index)" t="1692198799472"
            viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="976" width="15" height="15">
            <path
              d="M190.688 190.688a31.968 31.968 0 0 1 45.248 0l276.032 276.032 276.032-276.032a31.968 31.968 0 1 1 45.248 45.248l-276.032 276.032 276.032 276.032a32 32 0 0 1-45.248 45.248l-276.032-276.032-276.032 276.032a32 32 0 0 1-45.248-45.248l276.032-276.032-276.032-276.032a31.968 31.968 0 0 1 0-45.248z"
              p-id="977"></path>
          </svg>
        </div>
      </div>
      ...
      <svg class="stylish-select-dropdown-icon" @click="showDropdown = !showDropdown" @mouseleave="leaveDropdown = true"
        t="1692199626429" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2362" width="25"
        height="25">
        <path fill="rgba(199,29,35, 1)"
          d="M512 594.688c-2.112-2.048-4.544-4.48-7.552-7.488l-225.824-225.824a32 32 0 0 0-45.248 45.248l225.824 225.824a197.376 197.376 0 0 0 20.352 18.784c7.52 5.728 18.24 11.904 32.48 11.904s24.96-6.176 32.48-11.904c6.4-4.896 13.088-11.584 19.264-17.76l1.024-1.024 225.824-225.824a32 32 0 0 0-45.248-45.248l-225.824 225.824c-2.976 2.976-5.408 5.408-7.552 7.488z"
          p-id="2363"></path>
      </svg>
    </div>
